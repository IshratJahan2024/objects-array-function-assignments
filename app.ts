// Q No1:- Assignment1: building your friend list.
// learning objective:practice working with objects and arrays in typescript to create a data structure.
// Task: craeate aprograme that manages a simple friend list.
// 1- Define an object nameed people containing an empty array called friends.
// 2- create three seperate objects,each representing a friend,with properties like first name,
// last name,and optionaly ID.
// 3- Add these friends object to the friends array within the people object.
